...
public class Menu extends ListActivity {
    ...
    String classes[] = { "BgMusicLayoutActivity", "TextActivity", "Email", "Camera", "Data", "GFX", "GFXSurface", "SoundStuff", "Slider", "Tabs", "SimpleBrowser", "SharedPrefs", "InternalData", "ExternalData", "SQLiteExample", "SQLView", "Accelerate", "HttpExample" };
